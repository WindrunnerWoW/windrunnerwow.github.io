<script lang="ts">
  ...
  const category = getFeatureCategory('professions')!;
  const pages = category.links.filter((link) => link.href !== category.href);
</script>
...
<main>
  ...
  <section class="layout">
    <div>
      <h2>Slots, a new craft, and orders.</h2>
    </div>
    <div class="copy">
      <p>
        Mining, Herbalism, and Skinning no longer take primary profession slots, so they sit with Cooking, First Aid, 
        Fishing, and Survival. Jewelcrafting is the new primary. Survival &amp; Gardening is the trail secondary. 
        Crafting orders let trainers craft for you with gold and reagents. Material Storage keeps those reagents out of
        your bags and bank.
      </p>
    </div>
  </section>
