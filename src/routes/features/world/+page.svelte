<script lang="ts">
  ...
  const category = getFeatureCategory('world')!;
</script>
...
<main>
  ...
  <section class="layout">
    <div>
      <h2>Places, people, seasons, and sound.</h2>
    </div>
    <div class="copy">
      <p>
        Zones and map changes open new corners of Azeroth. Factions and quests give
        those places a story. Class design widens what you can play without rewriting Vanilla identities. Itemization
        puts rewards on the path. Seasonal events keep the calendar moving. New music and ambient work bring familiar
        corners closer.
      </p>
    </div>
  </section>
